...
import json # <-- αν δεν υπάρχει ήδη, θα μας χρειαστεί αργότερα

class Constants(BaseConstants):
    name_in_url = 'lottery_game'
    players_per_group = None
    num_rounds = 1  # <-- αφού παίζουν όλες μαζί σε μία σελίδα
...
class Player(BasePlayer):
    lottery_choice = models.IntegerField(
        choices=[(1, 'Option 1'), (2, 'Option 2'), (3, 'Option 3'), (4, 'Option 4'), (5, 'Option 5'),
                 (6, 'Option 6')],
        widget=widgets.RadioSelect
    )
    # ΝΕΟ: εδώ θα γράψουμε ΟΛΕΣ τις επιλογές από τη μία σελίδα
